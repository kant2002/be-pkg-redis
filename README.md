...
This repository contains the package with redis services - redlock, pubsub, cache and store.
...
In order to install and use the linked dependencies for `pkg-redis` the following command can be used:
